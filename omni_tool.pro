...
# QMAKE_CXXFLAGS += -O3 -march=native -flto -std=c++20 -Wno-unused-parameter -Wno-sign-compare
QMAKE_CXXFLAGS += -O2 -march=x86-64 -mtune=generic -std=c++20 -flto -Wno-unused-parameter -Wno-sign-compare
